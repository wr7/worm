...
public class ConnectionState {
  ...
  public ConnectionState(boolean left, boolean right, boolean top, boolean bottom) {
    this.bits = (byte) ((left ? 8 : 0) | (right ? 4 : 0) | (top ? 2 : 0) | (bottom ? 1 : 0));
  }
  ...
  public ConnectedSpriteType getType() {
    switch (bits()) {
      ...
      case (byte) 0b0001:
        return ConnectedSpriteType.SingleConnection;
      case (byte) 0b0010:
        return ConnectedSpriteType.SingleConnection;
      case (byte) 0b0100:
        return ConnectedSpriteType.SingleConnection;
      case (byte) 0b1000:
        return ConnectedSpriteType.SingleConnection;
      case (byte) 0b1010:
        return ConnectedSpriteType.LConnection;
      case (byte) 0b1001:
        return ConnectedSpriteType.LConnection;
      case (byte) 0b0110:
        return ConnectedSpriteType.LConnection;
      case (byte) 0b0101:
        return ConnectedSpriteType.LConnection;
      case (byte) 0b1100:
        return ConnectedSpriteType.StraightConnection;
      case (byte) 0b0011:
        return ConnectedSpriteType.StraightConnection;
      case (byte) 0b0111:
        return ConnectedSpriteType.TripleConnection;
      case (byte) 0b1011:
        return ConnectedSpriteType.TripleConnection;
      case (byte) 0b1101:
        return ConnectedSpriteType.TripleConnection;
      case (byte) 0b1110:
        return ConnectedSpriteType.TripleConnection;
      case (byte) 0b1111:
        return ConnectedSpriteType.Surrounded;
    }
  ...
  /**
   * Gets the needed clockwise rotation (radians) of a sprite based off of its connections to other
   * blocks.
   *
   * @see Sprite#getImages()
   */
