 ...
 *
 * <p>This class contains an x and a y value where:
 *
 * <ul>
 *   <li>x=0 is at the left side of the screen. Positive x is to the right
 *   <li>y=0 is at the top of the screen. Positive y is downwards
 * </ul>
 */
public class TilePosition {
  ...
  public boolean isOffscreen(Tile[][] tiles) {
    ...
    if (this.y >= tiles.length || this.x >= tiles[0].length) return true;
   ...
   *
   * <p>For example, <code>new TilePosition(2, 3).nextInDirection(Direction.Up)</code> will return
   * (2, 2) because (2, 2) is the tile above (2, 3).
   */
