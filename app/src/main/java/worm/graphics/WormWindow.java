...
/**
 * This represents the window used to play the game. Code for switching between/resetting levels and
 * handling keyboard presses lives here
 *
 * <p>The actual graphics code lives in WormGraphics
 */
public class WormWindow extends JPanel {
  ...
  public WormWindow() {
    ...
    this.getInputMap().put(KeyStroke.getKeyStroke("R"), "resetLevel");
    this.getActionMap().put("resetLevel", resetLevel);
  ...
  public Dimension getPreferredSize() {
    return new Dimension(
        levelToResetTo.tiles[0].length * TILE_SIZE, levelToResetTo.tiles.length * TILE_SIZE);
  }
